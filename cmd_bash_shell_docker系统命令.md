...
> [`k8s`是一个流行的容器管理编排平台，集中式管理数个服务的容器集群；](https://www.kubernetes.org.cn)　[project-docs](https://github.com/groovemonkey/project-based-kubernetes)　[docker-desktop](https://www.docker.com/products/docker-desktop)已集成compose和k8s<br>
