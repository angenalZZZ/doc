 ...
 * [Linux开发环境及常用安装zsh-git-redis-mysql-mongodb-pilosa-influxdb-nsq.kafka.gotify.botpress-ssh-airflow-fio](#linux开发环境及常用安装zsh-git-redis-mysql-mongodb-pilosa-influxdb-nsq.kafka.gotify.botpress-ssh-airflow-fio)
 * [Linux常用命令](#Linux常用命令)
...
## Linux开发环境及常用安装zsh-git-redis-mysql-mongodb-pilosa-influxdb-nsq.kafka.gotify.botpress-ssh-airflow-fio
