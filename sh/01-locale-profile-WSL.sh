...
##系统环境变量
export PATH="/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/mnt/c/WINDOWS:/mnt/c/WINDOWS/system32:/mnt/e/Tool/SysinternalsSuite:/mnt/a/go/bin"
