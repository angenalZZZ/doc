...
- 专用dns服务器工具`Acrylic`使用`sni`反向代理服务解锁网络
  * [获取`sni`反向代理](https://fofa.info/result?qbase64=Ym9keT0iQmFja2VuZCBub3QgYXZhaWxhYmxlIg%3D%3D)
  * [获取`Acrylic`本地DNS代理](https://sourceforge.net/projects/acrylic/files/Acrylic/2.1.1/Acrylic.exe/download)
  * Acrylic hosts
```
6.6.6.6   /^(.+\.)*akadns\.net$
6.6.6.6   /^(.+\.)*akam\.net$
