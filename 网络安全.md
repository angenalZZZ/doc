...
# aircrack-ng handshake-01.cap -j handshake-01
hcxpcapngtool handshake-01.cap -o handshake-01.hc22000
# 用hashcat破解密码  参数: -m 22000 模式 = WPA-PBKDF2-PMKID+EAPOL
# hashcat -m 2500 handshake-01.hccapx password.txt
hashcat --show --status -a 3 -m 22000 handshake-01.hc22000 password.txt
